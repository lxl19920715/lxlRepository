...
public class XJobApiController extends BaseController {
    ...
    public BaseResult qrySeriesData(
        ...
        Map resultMap = extendMapper.getNormalJobInstances() ;
    ...
    public BaseResult getRunningDetail(
        ...
        //统计实例总数
        Map resultMap = extendMapper.getTotalInstances() ;
...
//    @GetMapping(value = "/qryJobPageInfo")
    @GetMapping(value = "/qryJobPageInfo",produces = "application/json")
...
//        boolean isRun = xJobSubmit.isRun(jobId) ;
//        if(isRun){
//            return BaseResult.fail("该任务正在运行,不可再次运行!");
//        }
